...
public class ModBlocks {
    ...
    public static final Block COLORED_STONE_BRICKS = registerColoredBlock("colored_stone_bricks", Material.STONE);
    public static final Block COLORED_WOOD_PLANKS = registerColoredBlock("colored_wood_planks", Material.WOOD);
...
//        return Registry.register(Registries.BLOCK, new Identifier(ColoredBlocks.MOD_ID, name), block);
//    }
    private static Block registerColoredBlock(String name, Material material) {
