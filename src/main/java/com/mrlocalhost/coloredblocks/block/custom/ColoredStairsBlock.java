...
public class ColoredStairsBlock extends StairsBlock implements ColoredBlockInterface, BlockEntityProvider {
    private NbtCompound rgbValues;
    public ColoredStairsBlock(BlockState blockState, Settings settings) {
