...
public class ColoredBlocksConstants {
    ...
    public static final int MIN_RGB_VALUE = 0x0;
    public static final int MAX_RGB_VALUE = 0xF;
    ...
    public enum RGB_VALUES {
        RED(0, stripRedIntFromHex(0), stripGreenIntFromHex(0), stripBlueIntFromHex(0)),
        ORANGE(1, stripRedIntFromHex(1), stripGreenIntFromHex(1), stripBlueIntFromHex(1)),
        YELLOW(2, stripRedIntFromHex(2), stripGreenIntFromHex(2), stripBlueIntFromHex(2)),
        LIME(3, stripRedIntFromHex(3), stripGreenIntFromHex(3), stripBlueIntFromHex(3)),
        GREEN(4, stripRedIntFromHex(4), stripGreenIntFromHex(4), stripBlueIntFromHex(4)),
        CYAN(5, stripRedIntFromHex(5), stripGreenIntFromHex(5), stripBlueIntFromHex(5)),
        LIGHT_BLUE(6, stripRedIntFromHex(6), stripGreenIntFromHex(6), stripBlueIntFromHex(6)),
        BLUE(7, stripRedIntFromHex(7), stripGreenIntFromHex(7), stripBlueIntFromHex(7)),
        PURPLE(8, stripRedIntFromHex(8), stripGreenIntFromHex(8), stripBlueIntFromHex(8)),
        MAGENTA(9, stripRedIntFromHex(9), stripGreenIntFromHex(9), stripBlueIntFromHex(9)),
        PINK(10, stripRedIntFromHex(10), stripGreenIntFromHex(10), stripBlueIntFromHex(10)),
        BROWN(11, stripRedIntFromHex(11), stripGreenIntFromHex(11), stripBlueIntFromHex(11)),
        WHITE(12, stripRedIntFromHex(12), stripGreenIntFromHex(12), stripBlueIntFromHex(12)),
        LIGHT_GRAY(13, stripRedIntFromHex(13), stripGreenIntFromHex(13), stripBlueIntFromHex(13)),
        GRAY(14, stripRedIntFromHex(14), stripGreenIntFromHex(14), stripBlueIntFromHex(14)),
        BLACK(15, stripRedIntFromHex(15), stripGreenIntFromHex(15), stripBlueIntFromHex(15));
        private final int r, g, b;
        RGB_VALUES(int index, int r, int g, int b) {
            this.r=r;this.g=g;this.b=b;}
        public int r() { return this.r;}
        public int g() { return this.g;}
        public int b() { return this.b;}
        private static final List<RGB_VALUES> BY_VALUE = Arrays.stream(values()).toList();
        public static RGB_VALUES byIndex(int index) {
    ...
    public static final Block[] COLORED_TERRACOTTA = new Block[]{
        ...
        Blocks.GREEN_TERRACOTTA,Blocks.CYAN_TERRACOTTA,Blocks.LIGHT_BLUE_TERRACOTTA,Blocks.BLUE_TERRACOTTA,
        Blocks.PURPLE_TERRACOTTA,Blocks.MAGENTA_TERRACOTTA,Blocks.PINK_TERRACOTTA,Blocks.BROWN_TERRACOTTA,
    ...
    public static final Block[] COLORED_GLAZED_TERRACOTTA = new Block[]{
        Blocks.RED_GLAZED_TERRACOTTA,Blocks.ORANGE_GLAZED_TERRACOTTA,Blocks.YELLOW_GLAZED_TERRACOTTA,Blocks.LIME_GLAZED_TERRACOTTA,
        Blocks.GREEN_GLAZED_TERRACOTTA,Blocks.CYAN_GLAZED_TERRACOTTA,Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA,Blocks.BLUE_GLAZED_TERRACOTTA,
        Blocks.PURPLE_GLAZED_TERRACOTTA,Blocks.MAGENTA_GLAZED_TERRACOTTA,Blocks.PINK_GLAZED_TERRACOTTA,Blocks.BROWN_GLAZED_TERRACOTTA,
    ...
    public static final Block[] COLORED_CONCRETE = new Block[]{
        ...
        Blocks.GREEN_CONCRETE,Blocks.CYAN_CONCRETE,Blocks.LIGHT_BLUE_CONCRETE,Blocks.BLUE_CONCRETE,
        Blocks.PURPLE_CONCRETE,Blocks.MAGENTA_CONCRETE,Blocks.PINK_CONCRETE,Blocks.BROWN_CONCRETE,
    ...
    public static final Block[] COLORED_STAINED_GLASS = new Block[]{
        Blocks.RED_STAINED_GLASS,Blocks.ORANGE_STAINED_GLASS,Blocks.YELLOW_STAINED_GLASS,Blocks.LIME_STAINED_GLASS,
        Blocks.GREEN_STAINED_GLASS,Blocks.CYAN_STAINED_GLASS,Blocks.LIGHT_BLUE_STAINED_GLASS,Blocks.BLUE_STAINED_GLASS,
        Blocks.PURPLE_STAINED_GLASS,Blocks.MAGENTA_STAINED_GLASS,Blocks.PINK_STAINED_GLASS,Blocks.BROWN_STAINED_GLASS,
    ...
    public static final List<String> COLOR_MAP = new ArrayList<>(){{
        add("red");add("orange");add("yellow");add("lime");
        add("green");add("cyan");add("light_blue");add("blue");
        add("purple");add("magenta");add("pink");add("brown");
        add("white");add("light_gray");add("gray");add("black");
    }};
    ...
    public static final List<Block> COLORABLE_BLOCKS = new ArrayList<>(){{
        ...
        add(ModBlocks.COLORED_WOOD_PLANKS);
        for (int i = 0; i<16; i++) {
...
//            add(COLORED_WOOD_PLANK_SLAB[i]);
    ...
    public static final Item[] DYE_ITEMS = new Item[]{
        ...
        Items.GREEN_DYE,Items.CYAN_DYE,Items.LIGHT_BLUE_DYE,Items.BLUE_DYE,
        Items.PURPLE_DYE,Items.MAGENTA_DYE,Items.PINK_DYE,Items.BROWN_DYE,
